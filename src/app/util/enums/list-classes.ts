export const enum ListClasses {
  ...
  CARD = 'bg-gray-200 rounded-2xl hover:scale-125 hover:shadow-lg hover:shadow-zinc-900 hover:z-30',
  ...
  RADIO_BUTTON = 'flex flex-col justify-center items-center',
  LABEL_RADIO = 'text-slate-400 text-xx-s font-bold',
  HEADER_ADDRESSES = 'text-xs pb-3 text-address-color',
