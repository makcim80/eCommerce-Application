export const enum ListClasses {
  ...
  PARAGRAPH_MAIN_CONTENT = 'font-mono-s sm-ss:text-lg lg-l:text-xl 1200px:text-2xl bg-profile-bg bg-opacity-90 rounded-2xl',
  ...
  MAIN_CONTENT = 'p-3 flex gap-x-1 flex-col justify-center 515px:flex-row 515px:gap-x-3 bg-profile-bg bg-opacity-90 rounded-2xl',
