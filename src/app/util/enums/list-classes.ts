export const enum ListClasses {
  ...
  MODAL_BUTTON_SUCCESSFUL = 'border-2 rounded-full border-successful-color w-36px h-36px hover:bg-successful-color hover:text-white transition-all duration-300',
