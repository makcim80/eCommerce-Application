export const enum ListClasses {
  ...
  CAT_DETAILS_CONTAINER = 'cat-details-container flex flex-col items-center w-full h-full',
  CAT_DETAILS_CONTENT = 'cat-details-content p-2.5 w-900px max-w-full bg-white',
  CAT_DETAILS_SLIDER = 'cats-slider flex  w-500px h-500px overflow-x-scroll gap-x-4',
  CAT_DETAILS_IMG = 'cats-img w-500px h-500px object-contain h-full bg-white',
  CAT_DETAILS_NAME = 'cat-name',
  CAT_DETAILS_DESCRIPTION = 'cat-description',
  CAT_DETAILS_PRICE_DEFAULT = 'cat-price-default',
  CAT_DETAILS_PRICE_DEFAULT_OUTDATED = 'cat-price-default--outdated',
  CAT_DETAILS_PRICE_DISCOUNT = 'cat-price-discount',
