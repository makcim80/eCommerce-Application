export const enum ListClasses {
  ...
  MODAL_WINDOW_CONTAINER = 'placeholder-1',
  MODAL_WINDOW_HEADING = 'placeholder-2',
  MODAL_WINDOW_HEADING_TEXT = 'placeholder-3',
  MODAL_WINDOW_CONTENT = 'placeholder-4',
  MODAL_WINDOW_CONTENT_TEXT = 'placeholder-10',
  MODAL_ICON_WRP = 'placeholder-5',
  MODAL_ICON_SUCCESSFUL = 'placeholder-6',
  MODAL_ICON_ERROR = 'placeholder-7',
  MODAL_BUTTON_SUCCESSFUL = 'placeholder-8',
  MODAL_BUTTON_ERROR = 'placeholder-9',
}
