export const enum ListClasses {
  ...
  PARAGRAPH_MAIN_CONTENT = 'font-mono-s sm-ss:text-lg lg-l:text-xl 1200px:text-2xl',
  PARAGRAPH_MAIN_CONTENT_IMG = '515px:float-left mr-10',
  MAIN_CONTENT_TITLE = 'pb-5 text-sm flex justify-center font-serif-s font-bold sm-ss:text-xl lg-l:text-2xl 1200px:text-3xl',
  ...
  SWIPER = 'swiper w-full rounded-xl swiper-horizontal',
  ...
  MAIN_CONTENT = 'p-3 flex gap-x-1 flex-col justify-center 515px:flex-row 515px:gap-x-3',
  DIV_BLOCK = '515px:w-1/3 font-mono-s sm-ss:text-lg lg-l:text-xl 1200px:text-2xl',
  PARAGRAPH_MORE_MAIN_CONTENT = 'py-5 text-center',
}
