export const enum ListClasses {
  ...
  BUTTON_LOGOUT = 'mr-5 block text-black text-xs sm-s:text-sm lg-l:text-lg 2xl:text-2xl hover:border-b-2 hover:border-input-color hover:border-solid hover:text-input-color',
  HIDDEN = 'hidden',
  ...
  PROFILE = 'rounded-2xl border-1px m-3 p-2 border-label-profile max-w-4xl bg-profile-bg',
  ...
  INPUTFIELDCREATOR = 'flex flex-col max-w-xs',
