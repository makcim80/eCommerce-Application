export const enum ListClasses {
  ...
  CAT_DETAILS_SLIDER_TMP = 'cats-slider-tmp flex  w-500px h-500px overflow-x-scroll gap-x-4',
  CAT_DETAILS_IMG_TMP = 'cats-img-tmp w-500px h-500px object-contain h-full bg-profile-bg',
