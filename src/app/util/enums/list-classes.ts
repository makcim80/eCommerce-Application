export const enum ListClasses {
  ...
  CATALOG = 'catalog flex flex-wrap gap-x-6 p-2.5 sm-s:flex-nowrap',
  ...
  CARD = 'catalog-card bg-profile-bg rounded-2xl hover:scale-110 hover:shadow-2xl hover:shadow-zinc-900 transition active:scale-90 hover:z-30',
