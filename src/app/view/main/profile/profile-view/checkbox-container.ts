...
export default class CheckboxContainerView extends View {
  ...
  public setAttributes(): void {
    ...
    // this.shippingCheckbox?.input?.setAttribute('disabled', '');
    ...
    // this.billingCheckbox?.input?.setAttribute('disabled', '');
    ...
    // this.billingDefault?.input?.setAttribute('disabled', '');
    ...
    // this.shippingDefault?.input?.setAttribute('disabled', '');
  }
}
