...
export default class FirstNameProfile {
  ...
  public setAttributesFirstName(): void {
    ...
    if (this.label) {
      this.label.textContent = ListTextContent.FIRST_NAME_PROFILE;
    }
  }
